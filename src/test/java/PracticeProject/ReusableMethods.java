...
public class ReusableMethods {
	...
	{
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Ayushi\\Downloads\\chromedriver_win32\\chromedriver.exe");
    ...
    */
	...
	String path = "C:\\eclipse-workspace\\MyPracticeProject\\Reports" + filename;
...
public static void CloseTC()
{
  ...
  public static void ScreenShot() throws IOException
  {
	  ...
	  FileUtils.copyFile(source,new File("./ScreenShot/salesforce.png"));
  }
